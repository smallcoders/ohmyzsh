export const routeName = {
  ...
  OPERATION_ACTIVITY_PARAMETER: '/operate-activity/parameter-setting/index',//运营活动参数设置
  OPERATION_ACTIVITY_LINK: '/operate-activity/link-setting/index',//运营活动链接设置
...
export default [
    ...
    routes: [
      {
        ...
        code: 'M_PC_B',
        access: 'M_PC_B',
        redirect: '/solution-properties/banner',
      },
      {
        path: '/solution-properties/banner',
        code: 'M_PC_B',
        access: 'M_PC_B',
        name: 'banner管理',
        component: './solution_properties/banner/index',
      },
      {
        path: '/solution-properties/news',
        code: 'M_PC_XWZX',
        access: 'M_PC_XWZX',
        name: '新闻资讯',
        component: './solution_properties/news',
      },
      {
        path: '/solution-properties/industry_topic',
        code: 'M_PC_CYZT',
        access: 'M_PC_CYZT',
        name: '产业专题',
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/supply-demand-setting/solution',
        code: 'M_SD_FWGL',
        access: 'M_SD_FWGL',
        name: '服务管理',
        hideChildrenInMenu: true,
        routes: [
          {
            ...
            code: 'M_SD_FWGL',
            access: 'M_SD_FWGL',
            redirect: '/supply-demand-setting/solution/index',
          },
          {
            path: '/supply-demand-setting/solution/index',
            code: 'M_SD_FWGL', // tap 未处理
            access: 'M_SD_FWGL',
            hideInBreadcrumb: true,
            name: '服务管理',
            hideChildrenInMenu: true,
            component: './supply_demand_setting/solution',
          },
          {
            path: '/supply-demand-setting/solution/detail',
            name: '服务详情',
    ...
    routes: [
      {
        ...
        code: 'M_SM_XQGL',
        access: 'M_SM_XQGL',
        redirect: '/science-technology-manage/creative-need-manage',
      },
      {
        path: '/science-technology-manage/creative-need-manage',
        code: 'M_SM_XQGL',
        access: 'M_SM_XQGL',
        name: '创新需求管理',
        hideChildrenInMenu: true,
        routes: [
          {
            path: '/science-technology-manage/creative-need-manage',
            redirect: '/science-technology-manage/creative-need-manage/index',
          },
          {
            path: '/science-technology-manage/creative-need-manage/index',
            name: '创新需求管理',
            hideInBreadcrumb: true,
            component: './science_technology_manage/creative_need_manage/index',
          },
          {
            path: '/science-technology-manage/creative-need-manage/detail',
            name: '创新需求详情',
            component: './science_technology_manage/creative_need_manage/detail',
          },
        ],
      },
      {
        path: '/science-technology-manage/achievements-manage',
        code: 'M_SM_CGGL',
        access: 'M_SM_CGGL',
        name: '科技成果管理',
        hideChildrenInMenu: true,
        routes: [
          {
            path: '/science-technology-manage/achievements-manage',
            redirect: '/science-technology-manage/achievements-manage/index',
          },
          {
            path: '/science-technology-manage/achievements-manage/index',
            name: '科技成果管理',
            hideInBreadcrumb: true,
            component: './science_technology_manage/achievements_manage',
          },
          {
            path: '/science-technology-manage/achievements-manage/detail',
            name: '科技成果详情',
            component: './science_technology_manage/achievements_manage/detail',
          },
          {
            path: '/science-technology-manage/achievements-manage/multi-upload',
            name: '批量导入科技成果',
            component: './science_technology_manage/achievements_manage/multi_upload',
          },
        ],
      },
    ]
    ...
    routes: [
      {
        ...
        code: 'M_AM_YYZY',
        access: 'M_AM_YYZY',
        redirect: '/apply-manage/app-resource',
      },
      {
        path: '/apply-manage/app-resource',
        code: 'M_AM_YYZY',
        access: 'M_AM_YYZY',
        name: '应用资源',
        hideChildrenInMenu: true,
        // component: './apply_manage/app_resource',
        routes: [
          {
            path: '/apply-manage/app-resource',
            redirect: '/apply-manage/app-resource/index',
          },
          {
            path: '/apply-manage/app-resource/index',
            name: '应用资源',
            hideInBreadcrumb: true, // 隐藏面包屑
            component: './apply_manage/app_resource',
          },
          {
            path: '/apply-manage/app-resource/data-analysis',
            name: '综合采购数据分析',
            component: './apply_manage/data_analysis',
          },
          {
            path: '/apply-manage/app-resource/add-resource',
            name: '新增应用',
    ...
    routes: [
      {
        ...
        code: 'M_DA_YYLB',
        access: 'M_DA_YYLB',
        redirect: '/digital-application/app-list',
      },
      {
        path: '/digital-application/app-list',
        code: 'M_DA_YYLB',
        access: 'M_DA_YYLB',
        name: '应用列表',
        hideChildrenInMenu: true, // 隐藏面包屑
        routes: [
          {
            path: '/digital-application/app-list',
            redirect: '/digital-application/app-list/index',
          },
          {
            path: '/digital-application/app-list/index',
            name: '应用列表',
            hideInBreadcrumb: true,
            component: './digital_application/app_list/index',
          },
          {
    ...
    routes: [
      {
        ...
        code: 'M_RM_ZHBQ',
        access: 'M_RM_ZHBQ',
        redirect: 'recommend-manage/tags-management',
      },
      {
        path: '/recommend-manage/tags-management',
        code: 'M_RM_ZHBQ',
        access: 'M_RM_ZHBQ',
        name: '账号标签管理',
  ...
  },
  {
    ...
    routes: [
        ...
        routes: [
          {
            ...
            code: 'M_UM_ZJGL',
            access: 'M_UM_ZJGL',
            redirect: '/user-config/expert-manage/index',
          },
          {
            path: '/user-config/expert-manage/index',
            code: 'M_UM_ZJGL', // tap 未处理
            access: 'M_UM_ZJGL',
            hideInBreadcrumb: true,
            name: '专家管理',
            hideChildrenInMenu: true,
            component: './user_config/expert_manage',
          },
          {
            path: '/user-config/expert-manage/detail',
            name: '专家详情',
            hideInMenu: true,
      ...
      {
        path: '/user-config/org-type-manage',
        code: 'M_UM_JGLX',
        access: 'M_UM_JGLX',
        name: '机构类型管理',
        component: './user_config/org_type_manage',
      },
      {
        path: routeName.LOGOUT_RECORD,
        code: 'M_UM_ZXJL',
