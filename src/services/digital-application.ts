...
export async function editOrgList(data: { ids?: any }) {
  return request<ApplicationManager.CompanyResultList>(
    '/antelope-user/mng/dataManage/queryOrgList',
    {
      method: 'post',
      data,
    },
...
export async function getPushRecordList(data?: { [key: string]: any }) {
  return request<ApplicationManager.DetailResultList>(
    '/antelope-other/mng/api/manage/queryBagPage',
    {
      method: 'post',
      data,
    },
...
export async function getApplicationPushList(data?: { [key: string]: any }) {
  return request<ApplicationManager.DetailResultList>(
    '/antelope-other/mng/api/manage/queryChoiceAppPage',
    {
      method: 'post',
      data,
    },
...
export async function getApplyInfoPage(data?: { [key: string]: any }) {
  return request<ApplicationManager.ResultList>(
    '/antelope-other/mng/api/manage/queryApplyInfoPage',
    {
      method: 'post',
      data,
    },
...
// 新增接口配置
export async function addInterfaceConfig(data: {
  id?: number;
