...
export async function queryGyl(data?: Record<string, any>) {
  return request<any>('/antelope-finance/mng/supplier/queryGyl', {
    method: 'post',
    data,
  });
}
...
export async function queryOrg(data?: Record<string, any>) {
  return request<any>('/antelope-other/org/queryOrg', {
    method: 'post',
    data,
  });
}
...
export async function detailSupplier(id: number) {
  return request<any>(`/antelope-finance/mng/supplier/getSupplierDetail?id=${id}`, {
    method: 'get',
  });
}
