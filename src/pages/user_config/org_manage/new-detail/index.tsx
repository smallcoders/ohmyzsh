  ...
  return (
    ...
    <div className='org-manage-info' >
          ...
          <div  className='org-manage-info-col'>
            ...
            <div className='org-manage-info-col-title'><Tag color="#108ee9">{orgManageInfo?.industryCategoryName || '--'}</Tag></div>
          </div>
          <div  className='org-manage-info-col'>
          ...
          <div  className='org-manage-info-col'>
            ...
            <div className='org-manage-info-col-title'>{orgManageInfo?.scale || '--'}</div>
          </div>
          <div  className='org-manage-info-col'>
          ...
          <div  className='org-manage-info-col'>
            ...
            <div className='org-manage-info-col-title'>{orgManageInfo?.industryTxtList || '--'}</div>
          </div>
          <div  className='org-manage-info-col'>
          ...
          <div  className='org-manage-info-col'>
            ...
            <div className='org-manage-info-col-title'>{orgManageInfo?.businessType || '--'}</div>
          </div>
          <div  className='org-manage-info-col'>
