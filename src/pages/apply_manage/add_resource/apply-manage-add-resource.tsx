...
import './apply-manage-add-resource.less';
...
const sc = scopedClasses('apply-manage-add-resource');
export default () => {
  /**
   * 是否跳转连接 1 跳转 0 不跳
   */
    ...
    <PageContainer
      ...
      header={{
        ...
        breadcrumb: (
          <Breadcrumb>
            <Breadcrumb.Item>
              <Link to="/apply-manage">应用管理</Link>
            </Breadcrumb.Item>
            <Breadcrumb.Item>
              <Link to="/apply-manage/app-resource">应用管理 </Link>
            </Breadcrumb.Item>
            <Breadcrumb.Item>
