          ...
          {current==3 && (<div className={sc('modelWord')} >
            ...
            <div className={sc('modelWord-bk')} id={'imgShare'}>
              ...
              <div className="qr-anhui-pf">
                <QRCode
                  value={(window.location.protocol + '//' + window.location.host.split(':')[0] +`/antelope-activity-h5/antelope-download/index.html?shardCodeMaster=${shardCodeMaster}&preview=true`) }
                  renderAs={'canvas'}
                  size={113}
                  bgColor={'#FFFFFF'}
                  fgColor={'#000000'}
            ...
            <div className={sc('modelWord-bk1')} id={'imgShare1'}>
              ...
              <div className="qr-anhui-pf">
                <QRCode
                  value={(window.location.protocol + '//' + window.location.host.split(':')[0] +`/antelope-activity-h5/antelope-download/index.html?shardCodeMaster=${shardCodeMaster}&preview=false`)}
                  renderAs={'canvas'}
                  size={113}
                  bgColor={'#FFFFFF'}
                  fgColor={'#000000'}
