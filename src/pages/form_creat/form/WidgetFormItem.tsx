...
const WidgetFormItem: FC<Props> = (props) => {
  const {
    item,
    item: { key, type, label, config, remoteConfig, childNodes, formItemConfig },
    formInstance
  } = props
        ...
        {selectWidgetItem?.key === key && (
          <>
            <div className="widget-view-drag">
              <img src={require('../image/drag-widget.png')} alt='' className="drag-widget" />
            </div>
            <div className="widget-view-action">
              <img className="img-icon" src={require('../image/copy.png')} alt='' onClick={handleCopyClick} />
              <img className="img-icon" src={require('../image/delete.png')} alt='' onClick={handleDeleteClick} />
            </div>
          </>
        )}
      </>
