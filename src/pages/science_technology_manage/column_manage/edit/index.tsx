      ...
      <Form className={sc('container-form')} form={form}   onValuesChange={() => {
        ...
        >
          <Form.Item  label="Web端" required className={'pic'}>
            ...
            <div className={'pic-word'} style={{marginBottom:'20px'}}>限定一张图片，不超过5M，尺寸1200 * 160，格式支持png、jpg;</div>
          ...
          <Form.Item  label="App端"  className={'pic'}>
            ...
            <div className={'pic-word'} style={{marginBottom:'20px'}}>限定一张图片，不超过5M，尺寸375 * 150，格式支持png、jpg;</div>
