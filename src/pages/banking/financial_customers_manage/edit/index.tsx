...
export default () => {
  ...
  const handleSubmit = async () => {
    ...
    valueList.banks = valueList.banks.join(',')
    valueList.id = id;
  ...
  return (
    ...
    >
      <Form className={sc('container-form')} form={form}>
        ...
        <Form.Item name="scale" label="企业规模" required>
          <Input disabled />
        </Form.Item>
        <Form.Item
        ...
        >
          <Select
            options={getOptions(orgFormMap)}
            placeholder="请选择"
          />
        </Form.Item>
        <Form.Item
          name="legalQualification"
          label="法人资格"
          required
          rules={[
            {
        ...
        >
          <Select
            options={getOptions(legalQualificationMap)}
            placeholder="请选择"
          />
        </Form.Item>
        <Form.Item
        ...
        >
          <Select
            options={getOptions(economyTypeMap)}
            placeholder="请选择"
          />
        </Form.Item>
        <Form.Item
        ...
        >
          <Select
            options={getOptions(industryMap)}
            placeholder="请选择"
          />
        </Form.Item>
        ...
        >
          <Select
            options={getOptions(scienceMarkMap)}
            placeholder="请选择"
          />
        </Form.Item>
        <Form.Item
