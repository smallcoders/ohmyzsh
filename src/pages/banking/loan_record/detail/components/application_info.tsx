          ...
          <Row>
            ...
            </Col>
            {
              ...
              <Col span={24}>
                <span>已签署协议: </span>
                <span>
                  <span style={{cursor: 'pointer', color: '#0068ff'}} onClick={() => {window.open(detail?.urls?.[0])}}>《企业征信查询和使用授权书》</span>、<span style={{cursor: 'pointer', color: '#0068ff'}} onClick={() => {window.open(detail?.urls?.[1])}}>《个人征信查询和使用授权书》</span>
                </span>
              </Col>
            }
          </Row>
